...
const AdminConfig = () => {
  ...
  //   pedidoRecibido: true, pedidoConfirmado: true, pedidoEnPreparacion: true,
  //   pedidoEnviado: true, pedidoEntregado: true, pedidoCancelado: true,
  // });
  ...
  useEffect(() => {
    if (config) {
      ...
      // if (config.emailNotificaciones) setEmailNotificaciones(config.emailNotificaciones);
    }
  }, [config]);
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="space-y-5">
        ...
        {/* Notificaciones por email — desactivado temporalmente hasta resolver envío en producción */}
        {/* <div className="bg-white border border-gray-100 rounded-2xl p-6">
          ...
        </div> */}
